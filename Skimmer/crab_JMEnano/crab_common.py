...
config.Data.inputDBS     = 'phys03' #IMPORTANT! We're using a USER published dataset. Need this set.
#
...
#
config.Data.outLFNDirBase  = '/store/group/phys_jetmet/nbinnorj/'+reqNamePrefix+'_'+version+'/CRABOUTPUT/'
