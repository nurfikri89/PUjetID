...
Variables["jetSel0_dilep_dphi"] = Variable()
Variables["jetSel0_dilep_dphi"].varNameInTree = "jetSel0_dilep_dphi"
Variables["jetSel0_dilep_dphi"].xAxis = "#Delta#phi(dilep,jetSel0)"
Variables["jetSel0_dilep_dphi"].yAxis = "Events"
Variables["jetSel0_dilep_dphi"].doLogY = False
Variables["jetSel0_dilep_dphi"].nbins = 80
Variables["jetSel0_dilep_dphi"].xmin = -4.0
Variables["jetSel0_dilep_dphi"].xmax = 4.0
Variables["jetSel0_dilep_dphi"].rebins = []

Variables["jetSel0_dilep_dphi_norm"] = Variable()
Variables["jetSel0_dilep_dphi_norm"].varNameInTree = "jetSel0_dilep_dphi_norm"
Variables["jetSel0_dilep_dphi_norm"].xAxis = "#Delta#phi(dilep,jetSel0)/#pi"
Variables["jetSel0_dilep_dphi_norm"].yAxis = "Events"
Variables["jetSel0_dilep_dphi_norm"].doLogY = False
Variables["jetSel0_dilep_dphi_norm"].nbins  = 100
Variables["jetSel0_dilep_dphi_norm"].xmin =  0.0
Variables["jetSel0_dilep_dphi_norm"].xmax =  2.0
Variables["jetSel0_dilep_dphi_norm"].rebins = []
