...
Variables["jetSel0_pt"] = Variable()
Variables["jetSel0_pt"].varNameInTree = "jetSel0_pt"
Variables["jetSel0_pt"].xAxis = "Jet0 p_{T} [GeV]"
Variables["jetSel0_pt"].yAxis = "Events"
Variables["jetSel0_pt"].doLogY = False
Variables["jetSel0_pt"].nbins = 300
Variables["jetSel0_pt"].xmin = 0
Variables["jetSel0_pt"].xmax = 300
Variables["jetSel0_pt"].rebins = []

Variables["jetSel0_eta"] = Variable()
Variables["jetSel0_eta"].varNameInTree = "jetSel0_eta"
Variables["jetSel0_eta"].xAxis = "Jet0 #eta"
Variables["jetSel0_eta"].yAxis = "Events"
Variables["jetSel0_eta"].doLogY = False
Variables["jetSel0_eta"].nbins = etabins
Variables["jetSel0_eta"].xmin = etamin
Variables["jetSel0_eta"].xmax = etamax
Variables["jetSel0_eta"].rebins = []

Variables["jetSel0_phi"] = Variable()
Variables["jetSel0_phi"].varNameInTree = "jetSel0_phi"
Variables["jetSel0_phi"].xAxis = "Jet0 #phi"
Variables["jetSel0_phi"].yAxis = "Events"
Variables["jetSel0_phi"].doLogY = False
Variables["jetSel0_phi"].nbins = phibins
Variables["jetSel0_phi"].xmin = phimin
Variables["jetSel0_phi"].xmax = phimax
Variables["jetSel0_phi"].rebins = []

Variables["jetSel0_dimuon_dphi"] = Variable()
Variables["jetSel0_dimuon_dphi"].varNameInTree = "jetSel0_dimuon_dphi"
Variables["jetSel0_dimuon_dphi"].xAxis = "#Delta#phi(dimuon,jetSel0)"
Variables["jetSel0_dimuon_dphi"].yAxis = "Events"
Variables["jetSel0_dimuon_dphi"].doLogY = False
Variables["jetSel0_dimuon_dphi"].nbins = 80
Variables["jetSel0_dimuon_dphi"].xmin = -4.0
Variables["jetSel0_dimuon_dphi"].xmax = 4.0
Variables["jetSel0_dimuon_dphi"].rebins = []

Variables["jetSel0_dimuon_dphi_norm"] = Variable()
Variables["jetSel0_dimuon_dphi_norm"].varNameInTree = "jetSel0_dimuon_dphi_norm"
Variables["jetSel0_dimuon_dphi_norm"].xAxis = "#Delta#phi(dimuon,jetSel0)/#pi"
Variables["jetSel0_dimuon_dphi_norm"].yAxis = "Events"
Variables["jetSel0_dimuon_dphi_norm"].doLogY = False
Variables["jetSel0_dimuon_dphi_norm"].nbins  = 100
Variables["jetSel0_dimuon_dphi_norm"].xmin =  0.0
Variables["jetSel0_dimuon_dphi_norm"].xmax =  2.0
Variables["jetSel0_dimuon_dphi_norm"].rebins = []
